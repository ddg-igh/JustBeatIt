...
public class SeekBarPreference extends DialogPreference implements SeekBar.OnSeekBarChangeListener, OnClickListener
{
    ...
    private String mDefault, mMax, mValue = "0";
    ...
    public SeekBarPreference(Context context, AttributeSet attrs) {
        ...
        mMax = attrs.getAttributeValue(androidns, "max");
    }
    ...
    protected View onCreateDialogView() {
        ...
        mSeekBar.setMax(Integer.parseInt(mMax));
        mSeekBar.setProgress(Integer.parseInt(mValue));
    ...
    protected void onSetInitialValue(boolean restore, Object defaultValue)  
    {
        ...
        if (restore) 
            mValue = shouldPersist() ? getPersistedString(mDefault) : "0";
            else 
    ...
    public void setMax(int max) { mMax = String.valueOf(max); }
    public int getMax() { return Integer.parseInt(mMax); }
    ...
    public int getProgress() { return Integer.parseInt(mValue); }
    ...
    public void onClick(View v) {
        ...
        if (shouldPersist()) {
            ...
            mValue = String.valueOf(mSeekBar.getProgress());
            persistString(String.valueOf(mSeekBar.getProgress()));
